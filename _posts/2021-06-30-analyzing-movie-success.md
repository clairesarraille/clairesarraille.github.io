...
This exploratory data analysis project measures movie success in terms of net revenue (profit) during the period 2016-2021. Imagining that I was helping develop early R&D for an upcoming movie studio, I started with a collection of the 3,000 highest revenue movies of 2016-2021. I threw out those not originally shot in English, and any missing a genre or production company. I further narrowed the scope to the upper quartile of profit, resulting in a neat 606 titles to focus on for the majority of the visualizations.
